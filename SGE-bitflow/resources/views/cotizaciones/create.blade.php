                ...
                <div class="table-responsive"> 
                    <table class="table table-bordered table-sm mb-0">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <td colspan="5" class="text-right font-weight-bold">Total sin descuento %:</td>
                                <td id="total">$0.00</td>
                            </tr>
                            <tr>
                                <td colspan="5" class="text-right font-weight-bold">Total con descuento %:</td>
                                <td id="total_dcto">$0.00</td>
                            </tr>
                            <tr>
                                <td colspan="6" class="text-right">
                                    <button type="submit" id="guardarCBtn" class="btn btn-primary">Guardar Cotización</button>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
...
<script>
    ...
    $(document).ready(function() {
        ...
        document.getElementById('guardarCBtn').addEventListener('click', function(e) {
            ...
            if (productosGuardados.length === 0 && itemslibresGuardados.length === 0) {
                Swal.fire({
                    icon: 'warning',
                    title: 'No hay productos o items libres seleccionados',
                    showConfirmButton: false,
                    timer: 1500
                });
                return;
